...
class App extends Component {
    render() {
        const data = [
            {src: '../../img/our-best-solimo.png', descr: 'Solimo Coffee Beans 2 kg', price: 10.73, id: 1},
            {src: '../../img/our-best-presto.png', descr: 'Presto Coffee Beans 1 kg', price: 15.99, id: 2},
            {src: '../../img/our-best-aromisto.png', descr: 'AROMISTICO Coffee 1 kg', price: 6.99, id: 3}
        ]
        return (
            <div className="app">
                <CoffeeHouseHeader/>
